...
export default function CheckScore() {
  ...
  const handleCheckScore = (quizId: string) => {
    navigate(`/check-score/student?id=${quizId}`);
  };
            ...
            filteredQuizzes.map((quiz) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => handleCheckScore(quiz.id)}
                    className="bg-brand-red hover:bg-red-700 text-white px-4 py-2 rounded-full font-medium transition-colors text-sm"
                  >
